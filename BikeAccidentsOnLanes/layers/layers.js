...
var format_BikeAccidentsWithoutBeforeBikeLane_3 = new ol.format.GeoJSON();
var features_BikeAccidentsWithoutBeforeBikeLane_3 = format_BikeAccidentsWithoutBeforeBikeLane_3.readFeatures(json_BikeAccidentsWithoutBeforeBikeLane_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BikeAccidentsWithoutBeforeBikeLane_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BikeAccidentsWithoutBeforeBikeLane_3.addFeatures(features_BikeAccidentsWithoutBeforeBikeLane_3);
var lyr_BikeAccidentsWithoutBeforeBikeLane_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BikeAccidentsWithoutBeforeBikeLane_3, 
                style: style_BikeAccidentsWithoutBeforeBikeLane_3,
                popuplayertitle: 'Bike Accidents Without/Before BikeLane',
                interactive: true,
                title: '<img src="styles/legend/BikeAccidentsWithoutBeforeBikeLane_3.png" /> Bike Accidents Without/Before BikeLane'
            });
...
lyr_CartoDbPositron_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(false);lyr_BikeLanes_2.setVisible(true);lyr_BikeAccidentsWithoutBeforeBikeLane_3.setVisible(true);lyr_BikeAccidentswithBikeLane_4.setVisible(true);
var layersList = [lyr_CartoDbPositron_0,lyr_OpenStreetMap_1,lyr_BikeLanes_2,lyr_BikeAccidentsWithoutBeforeBikeLane_3,lyr_BikeAccidentswithBikeLane_4];
